...
for _, row in df.iterrows():
    ...
    df_out["correct_country"].append(country), neg_df_out["correct_country"].append(
        country
    )
...
df_out.to_csv(os.path.join(ROOT, "cities.csv"), index=False), neg_def_out.to_csv(
    os.path.join(ROOT, "neg_cities.csv"), index=False
)

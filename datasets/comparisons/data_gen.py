...
for i, x in enumerate(numbers):
    for j, y in enumerate(numbers):
        ...
        larger_out["statement"].append(larger_statement), smaller_out[
            "statement"
        ].append(smaller_statement)
        larger_out["label"].append(larger_label), smaller_out["label"].append(
            smaller_label
        )
        ...
        larger_out["abs_diff"].append(abs(i - j)), smaller_out["abs_diff"].append(
            abs(i - j)
        )
